...
@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Preloader', 'sub_title' => 'Pages'])
            ...
            <div class="card cta-box bg-primary text-white">
                <div class="card-body">
                    <div class="d-flex align-items-start align-items-center">
                        ...
                        <img class="ms-3" src="/images/svg/email-campaign.svg" width="120"
                            alt="Generic placeholder image">
                    </div>
                </div>
                <!-- end card-body -->
...
@section('script-bottom')
    @vite(['resources/js/ui/component.todo.js', 'resources/js/pages/demo.crm-dashboard.js'])
@endsection
