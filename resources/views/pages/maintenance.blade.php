...
<head>
    @include('layouts.shared/title-meta', ['page_title' => 'Maintenance'])
            ...
            <div class="row justify-content-center">
                <div class="col-xl-10">
                    ...
                    <div class="text-center">
                        <img src="/images/svg/maintenance.svg" height="140" alt="File not found Image">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-4">
                                <div class="text-center mt-3 ps-1 pe-1">
                                    ...
                                    <p class="text-muted">Contrary to popular belief, Lorem Ipsum is not simply random
                                        text. It has roots in a piece of classical but the majority.</p>
                                </div>
                            </div> <!-- end col-->
                            <div class="col-md-4">
                                <div class="text-center mt-3 ps-1 pe-1">
                                    ...
                                    <p class="text-muted">If you are going to use a passage of Lorem Ipsum, you need to
                                        be sure there isn't anything embar.. <a href="mailto:#"
