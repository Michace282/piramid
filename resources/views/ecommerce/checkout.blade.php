@extends('layouts.vertical', ['title' => 'Checkout', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
@include('layouts.shared/page-title',['page_title' => 'Checkout','sub_title' => 'Ecommerce'])
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="text-sm-end">
                                                <a href="{{ route('second', ['ecommerce' , 'checkout']) }}" class="btn btn-danger">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-nowrap table-centered mb-0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-1.jpg" alt="contact-img" title="contact-img" class="rounded me-2"
                                                            height="48" />
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-2.jpg" alt="contact-img" title="contact-img" class="rounded me-2"
                                                            height="48" />
                                                        <p class="m-0 d-inline-block align-middle">
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-3.jpg" alt="contact-img" title="contact-img" class="rounded me-2"
                                                            height="48" />
                                                        <p class="m-0 d-inline-block align-middle">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-nowrap table-centered mb-0">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-1.jpg" alt="contact-img"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-2.jpg" alt="contact-img"
                                                            title="contact-img" class="rounded me-2" height="48" />
                                                        <p class="m-0 d-inline-block align-middle">
                                                            <a href="apps-ecommerce-products-details.html"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-3.jpg" alt="contact-img"
                                                            title="contact-img" class="rounded me-2" height="48" />
                                                        <p class="m-0 d-inline-block align-middle">
                                                            <a href="apps-ecommerce-products-details.html"
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="border p-3 mb-3 rounded">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                            <img src="/images/payments/paypal.png" height="25" alt="paypal-img">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="border p-3 mb-3 rounded">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                            <img src="/images/payments/master.png" height="24" alt="master-card-img">
                                            <img src="/images/payments/discover.png" height="24" alt="discover-card-img">
                                            <img src="/images/payments/visa.png" height="24" alt="visa-card-img">
                                            <img src="/images/payments/stripe.png" height="24" alt="stripe-card-img">
                                        </div>
                                    </div> <!-- end row -->
                                    <div class="row mt-4">
                                        <div class="col-md-12">
                                ...
                                <div class="border p-3 mb-3 rounded">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                            <img src="/images/payments/payoneer.png" height="30" alt="paypal-img">
                                        </div>
                                    </div>
                                </div>
