@extends('layouts.vertical', ['title' => 'Shopping Cart', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
@include('layouts.shared/page-title',['page_title' => 'Shopping Cart','sub_title' => 'Ecommerce'])
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless table-nowrap table-centered mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="/images/products/product-5.jpg" alt="contact-img"
                                                title="contact-img" class="rounded me-3" height="64" />
                                            <p class="m-0 d-inline-block align-middle font-16">
                                                <a href="apps-ecommerce-products-details.html"
...
@section('script')
@vite(['resources/js/pages/demo.customers.js'])
@endsection