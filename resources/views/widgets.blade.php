@extends('layouts.vertical', ['title' => 'Widgets', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
    @include('layouts.shared/page-title', ['sub_title' => 'Components', 'page_title' => 'Widgets'])
            ...
            <div class="card cta-box text-bg-danger">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <img class="ms-3" src="/images/svg/email-campaign.svg" width="120" alt="Generic placeholder image">
                    </div>
                </div>
                <!-- end card-body -->
            </div>
            ...
            <div class="card cta-box text-bg-primary">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <img class="my-3" src="/images/svg/report.svg" width="180" alt="Generic placeholder image">
