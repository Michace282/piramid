@extends('layouts.vertical', ['title' => 'Task Detail', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex justify-content-between">
                                    <div id="tooltip-container">
                                        <img src="/images/users/avatar-9.jpg" alt="image" class="avatar-xs rounded-circle me-1"
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex justify-content-between">
                                    <div id="tooltip-container1">
                                        <img src="/images/users/avatar-2.jpg" alt="image" class="avatar-xs rounded-circle me-1"
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex justify-content-between">
                                    <div id="tooltip-container2">
                                        <img src="/images/users/avatar-4.jpg" alt="image" class="avatar-xs rounded-circle me-1"
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex justify-content-between">
                                    <div id="tooltip-container5">
                                        <img src="/images/users/avatar-7.jpg" alt="image" class="avatar-xs rounded-circle me-1"
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex justify-content-between">
                                    <div id="tooltip-container8">
                                        <img src="/images/users/avatar-5.jpg" alt="image" class="avatar-xs rounded-circle me-1"
