@extends('layouts.vertical', ['title' => 'Kanban Board', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                ...
                <div id="task-list-one" class="task-list-items">
                    ...
                    <div class="card mb-0">
                        <div class="card-body p-3">
                            ...
                            <p class="mb-0">
                                <img src="/images/users/avatar-2.jpg" alt="user-img" class="avatar-xs rounded-circle me-1" />
                    ...
                    <div class="card mb-0">
                        <div class="card-body p-3">
                            ...
                            <p class="mb-0">
                                <img src="/images/users/avatar-1.jpg" alt="user-img" class="avatar-xs rounded-circle me-1" />
                    ...
                    <div class="card mb-0">
                        <div class="card-body p-3">
                            ...
                            <p class="mb-0">
                                <img src="/images/users/avatar-3.jpg" alt="user-img" class="avatar-xs rounded-circle me-1" />
                ...
                <div id="task-list-two" class="task-list-items">
                    ...
                    <div class="card mb-0">
                        <div class="card-body p-3">
                            ...
                            <p class="mb-0">
                                <img src="/images/users/avatar-5.jpg" alt="user-img" class="avatar-xs rounded-circle me-1" />
                    ...
                    <div class="card mb-0">
                        <div class="card-body p-3">
                            ...
                            <p class="mb-0">
                                <img src="/images/users/avatar-6.jpg" alt="user-img" class="avatar-xs rounded-circle me-1" />
                ...
                <div id="task-list-three" class="task-list-items">
                    ...
                    <div class="card mb-0">
                        <div class="card-body p-3">
                            ...
                            <p class="mb-0">
                                <img src="/images/users/avatar-9.jpg" alt="user-img" class="avatar-xs rounded-circle me-1" />
                    ...
                    <div class="card mb-0">
                        <div class="card-body p-3">
                            ...
                            <p class="mb-0">
                                <img src="/images/users/avatar-8.jpg" alt="user-img" class="avatar-xs rounded-circle me-1" />
                    ...
                    <div class="card mb-0">
                        <div class="card-body p-3">
                            ...
                            <p class="mb-0">
                                <img src="/images/users/avatar-4.jpg" alt="user-img" class="avatar-xs rounded-circle me-1" />
                ...
                <div id="task-list-four" class="task-list-items">
                    ...
                    <div class="card mb-0">
                        <div class="card-body p-3">
                            ...
                            <p class="mb-0">
                                <img src="/images/users/avatar-10.jpg" alt="user-img" class="avatar-xs rounded-circle me-1" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control form-control-light" id="birthdatepicker" >
                            </div>
                        </div>
                    </div>
...
@section('script')
    @vite(['resources/js/ui/component.dragula.js'])
@endsection
