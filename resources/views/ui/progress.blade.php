        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">A progress bar can be used to show a user how far along he/she is in a
                        process.</p>

                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#default-progress-preview" data-bs-toggle="tab" aria-expanded="false"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">We only set a <code>height</code> value on the <code>.progress</code>,
                        so
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#height-progress-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">Include multiple progress bars in a progress component if you
                        need.</p>

                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#multiple-progress-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#multiple-progress-code" data-bs-toggle="tab" aria-expanded="true"
                               class="nav-link">
                                Code
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">The striped gradient can also be animated. Add
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#animated-progress-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#animated-progress-code" data-bs-toggle="tab" aria-expanded="true"
                               class="nav-link">
                                Code
                            </a>
                        </li>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">Add labels to your progress bars by placing text within the
                        <code>.progress-bar</code>.</p>

                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#labels-progress-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">Use background utility classes to change the appearance of individual
                        progress bars.</p>

                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#background-progress-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#background-progress-code" data-bs-toggle="tab" aria-expanded="true"
                               class="nav-link">
                                Code
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">Add <code>.progress-bar-striped</code> to any
                        <code>.progress-bar</code>
                        to apply a stripe via CSS gradient over the progress bar’s background color.</p>

                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#striped-progress-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
