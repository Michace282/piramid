@extends('layouts.vertical', ['title' => 'Ribbons', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
    @include('layouts.shared/page-title', ['sub_title' => 'Base UI', 'page_title' => 'Ribbons'])
                ...
                <div class="tab-pane show active" id="ribbons-preview">
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card ribbon-box">
                                <div class="card-body">
                                    <div class="ribbon ribbon-info float-end"><i class="mdi mdi-access-point me-1"></i>
                                        Info
                                    </div>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card ribbon-box">
                                <div class="card-body">
                                    <div class="ribbon ribbon-warning float-start"><i
                                            class="mdi mdi-access-point me-1"></i>
                                        Warning
                                    </div>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card ribbon-box">
                                <div class="card-body">
                                    <div class="ribbon ribbon-dark bg-dark text-light float-end"><i
                                            class="mdi mdi-access-point me-1"></i> Dark
                                    </div>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card ribbon-box">
                                <div class="card-body">
                                    <div class="ribbon-two ribbon-two-secondary"><span
                                            class="bg-secondary text-light">Secondary</span></div>
                                    <p class="mb-0">Quisque nec turpis at urna dictum luctus. Suspendisse
                                        convallis dignissim eros at volutpat. In egestas mattis dui. Aliquam
                                        mattis dictum aliquet. Nulla sapien mauris, eleifend et sem ac,
                                        commodo dapibus odio. Vivamus pretium nec odio cursus elementum.
