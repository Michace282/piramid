                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="icon-alerts-preview">
                            ...
                            <div class="alert alert-danger" role="alert">
                                <i class="ri-close-circle-line me-1 align-middle font-16"></i> This is a
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#additional-content-preview" data-bs-toggle="tab" aria-expanded="false"
                                class="nav-link active">
                                Preview
                            </a>
                        </li>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14 mb-3">Click the button below to show an alert (hidden with inline styles
                        to start), then dismiss (and destroy) it with the built-in close button.</p>

                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#live-alert-preview" data-bs-toggle="tab" aria-expanded="false"
                                class="nav-link active">
                                Preview
                            </a>
                        </li>
