        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#border-spinner-preview" data-bs-toggle="tab" aria-expanded="false"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#colored-spinner-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">Use flexbox utilities, float utilities, or text alignment utilities to
                        place spinners exactly where you need them in any situation.</p>

                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#alignment-spinner-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#alignment-spinner-code" data-bs-toggle="tab" aria-expanded="true"
                               class="nav-link">
                                Code
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">Add <code>.spinner-border-sm</code> and
                        <code>.spinner-border.avatar-**</code> to make a smaller spinner that can quickly be used within
                        other components.
                    </p>

                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#size-spinner-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">If you don’t fancy a border spinner, switch to the grow spinner. While
                        it
                        doesn’t technically spin, it does repeatedly grow!</p>

                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#growing-spinner-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">You can use any of our text color utilities on the standard
                        spinner.</p>

                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#colored-growing-spinner-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#colored-growing-spinner-code" data-bs-toggle="tab" aria-expanded="true"
                               class="nav-link">
                                Code
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">Use <code>flexbox utilities</code>, <code>float utilities</code>, or
                        <code>text alignment</code> utilities to place spinners exactly where you need them in any
                        situation.</p>

                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#placement-spinner-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#placement-spinner-code" data-bs-toggle="tab" aria-expanded="true"
                               class="nav-link">
                                Code
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">Use spinners within buttons to indicate an action is currently
                        processing
                        or taking place.
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#buttons-spinner-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
