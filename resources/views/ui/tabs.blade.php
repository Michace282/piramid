            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#default-tabs-preview" data-bs-toggle="tab" aria-expanded="false"
                        ...
                        <div class="tab-pane show active" id="default-tabs-preview">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="home">
                                    ...
                                    <p class="mb-0">Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu.
                                        In
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14 mb-3">Using class <code>.nav-justified</code>, you can force your
                        <code>tab
                            menu items</code> to use the full available width.</p>

                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#justified-tabs-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
                        ...
                        <div class="tab-pane show active" id="justified-tabs-preview">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="home1">
                                    <p>Leggings occaecat dolor sit amet, consectetuer adipiscing elit. Aenean commodo
                                        ligula
                                        eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient
                                        montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque
                                        eu,
                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade active show" id="v-pills-home" role="tabpanel"
                                            ...
                                            <p class="mb-0">Cillum ad ut irure tempor velit nostrud occaecat ullamco
                                                ...
                                                do esse magna mollit excepteur laborum qui. Id id reprehenderit sit est
                                                eu
                                        ...
                                        <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                            ...
                                            <p class="mb-0">Culpa dolor voluptate do laboris laboris irure reprehenderit
                                                id incididunt duis pariatur mollit aute magna
                                                pariatur consectetur. Eu veniam duis non ut dolor deserunt commodo et
                                                minim
                                                in quis laboris ipsum velit
                                                id veniam. Quis ut consectetur adipisicing officia excepteur non sit. Ut
                                                et
                                                elit aliquip labore Leggings
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#vertical-right-tabs-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#vertical-right-tabs-code" data-bs-toggle="tab" aria-expanded="true"
                               class="nav-link">
                                Code
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-pills bg-nav-pills mb-3">
                        <li class="nav-item">
                            <a href="#bordered-tabs-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link rounded-0 active">
                                Preview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#bordered-tabs-code" data-bs-toggle="tab" aria-expanded="true"
                               class="nav-link rounded-0">
                                Code
                            </a>
                        </li>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-pills bg-nav-pills mb-3">
                        <li class="nav-item">
                            <a href="#bordered-justified-tabs-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link rounded-0 active">
                                Preview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#bordered-justified-tabs-code" data-bs-toggle="tab" aria-expanded="true"
                               class="nav-link rounded-0">
                                Code
                            </a>
                        </li>
