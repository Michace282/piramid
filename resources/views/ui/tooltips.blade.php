            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        ...
                        <li class="nav-item">
                            <a href="#disabled-tooltips-code" data-bs-toggle="tab" aria-expanded="true"
                               class="nav-link">
                                Code
                            </a>
                        </li>
                        ...
                        <div class="tab-pane show active" id="disabled-tooltips-preview">
                            <div>
                                <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip"
                                    ...
                                    <button class="btn btn-primary pe-none" type="button"
        ...
        <div class="col-xl-6">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="four-tooltips-preview">
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <button type="button" class="btn btn-info" data-bs-toggle="tooltip"
                                        data-bs-placement="bottom" data-bs-title="Tooltip on bottom">Tooltip on bottom
                                </button>
                                <button type="button" class="btn btn-info" data-bs-toggle="tooltip"
                                        data-bs-placement="left" data-bs-title="Tooltip on left">Tooltip on left
                                </button>
                                <button type="button" class="btn btn-info" data-bs-toggle="tooltip"
                                        data-bs-placement="right" data-bs-title="Tooltip on right">Tooltip on right
                                </button>
                            </div>
                        </div> <!-- end preview-->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">We set a custom class with ex.
                        <code>data-bs-custom-class="primary-tooltip"</code> to scope our background-color primary
                        appearance and use
