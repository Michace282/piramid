                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active-items-preview">
                            <ul class="list-group">
                                <li class="list-group-item active"><i class="uil-google-drive-alt me-1"></i> Google
                                    Drive
                                </li>
                                <li class="list-group-item"><i class="uil-facebook-messenger me-1"></i>
                                    Facebook Messenger
                        ...
                        <div class="tab-pane show active" id="disabled-items-preview">
                            <ul class="list-group">
                                <li class="list-group-item disabled" aria-disabled="true"><i
                                        class="uil-google-drive-alt me-1"></i> Google Drive
                                </li>
                                <li class="list-group-item"><i class="uil-facebook-messenger me-1"></i>
                                    Facebook Messenger
                                </li>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#contextual-link-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#checkboxes-and-radios-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#checkboxes-and-radios-code" data-bs-toggle="tab" aria-expanded="true"
                               class="nav-link">
                                Code
                            </a>
                        </li>
