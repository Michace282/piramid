@extends('layouts.vertical', ['title' => 'Ratings', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
    @include('layouts.shared/page-title', ['sub_title' => 'Extended', 'page_title' => 'Ratings'])
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#default-ratings-preview" data-bs-toggle="tab" aria-expanded="false"
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane code" id="default-ratings-code">
                            <p class="mt-3">Make sure to include following js files at end of <code>body element</code>
                            </p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#change-icon-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#using-select-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="using-select-preview">
                            ...
                            <div class="rateit rateit-mdi" data-rateit-backingfld="#backing3b" data-rateit-mode="font"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#javascript-interaction-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#javascript-interaction-code" data-bs-toggle="tab" aria-expanded="true"
                               class="nav-link">
                                Code
                            </a>
                        </li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="javascript-interaction-preview">
                            <div class="rateit rateit-mdi" id="js-interaction" data-rateit-min="2"
                                 data-rateit-mode="font" data-rateit-icon="󰓒">
                            </div>
                            <div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#mdi-ratings-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#icon-font-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#readonly-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">All properties can also be set on the fly. Here are a few
                        examples:</p>

                    <ul class="nav nav-tabs nav-bordered mb-3">
                        <li class="nav-item">
                            <a href="#getting-values-preview" data-bs-toggle="tab" aria-expanded="false"
                               class="nav-link active">
                                Preview
                            </a>
                        </li>
                        ...
                        <div class="tab-pane show active" id="getting-values-preview">
                            ...
                            <div class="d-flex flex-wrap gap-2 mt-3">
                                <button class="btn btn-sm btn-primary"
                                        onclick="alert($('#getting-values').rateit('value'))">Get value
                                </button>
                                <button class="btn btn-sm btn-primary"
                                ...
                                <button class="btn btn-sm btn-primary"
                                        onclick="alert($('#getting-values').rateit('max'))">Get max value
                                </button>
                                <button class="btn btn-sm btn-primary"
                                ...
                                <button class="btn btn-sm btn-primary"
                                        onclick="alert($('#getting-values').rateit('step'))">Get step size
                                </button>
                                <button class="btn btn-sm btn-primary"
                                ...
                                <button class="btn btn-sm btn-primary"
                                        onclick="alert($('#getting-values').rateit('readonly'))">Get readonly value
                                </button>
                                <button class="btn btn-sm btn-primary"
                                ...
                                <button class="btn btn-sm btn-primary"
                                        onclick="alert($('#getting-values').rateit('ispreset'))">Get ispreset value
                                </button>
                                <button class="btn btn-sm btn-primary"
                                        onclick="$('#getting-values').rateit('ispreset',!$('#getting-values').rateit('ispreset'))">
                                    Toggle ispreset
                                </button>
                                <button class="btn btn-sm btn-primary" onclick="$('#getting-values').rateit('reset')">
                                    Reset
                                </button>
                            </div>
                        </div> <!-- end preview-->
...
@section('script')
    @vite(['resources/js/ui/component.rating.js','resources/js/hyper-syntax.js'])
@endsection
