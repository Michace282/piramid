@extends('layouts.vertical', ['title' => 'Social Feed', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('css')
@endsection

@section('content')
@include('layouts.shared/page-title',['page_title' => 'Social Feed','sub_title' => 'Apps'])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-self-start">
                        <img class="d-flex align-self-start rounded me-2" src="/images/users/avatar-5.jpg"
        ...
        <div class="col-xxl-6 col-lg-12 order-lg-2 order-xxl-1">
            ...
            <div class="card">
                <div class="card-body pb-1">
                    <div class="d-flex">
                        <img class="me-2 rounded" src="/images/users/avatar-3.jpg" alt="Generic placeholder image"
                            height="32">
                        <div class="w-100">
                    ...
                    <div class="font-16 text-center text-dark my-3">
                        <i class="mdi mdi-format-quote-open font-20"></i> Leave one wolf alive and the sheep are never
                        safe. When people ask you
                    ...
                    <div class="mt-3">
                        <div class="d-flex">
                            <img class="me-2 rounded" src="/images/users/avatar-9.jpg" alt="Generic placeholder image"
                                height="32">
                            <div>
                                ...
                                <div class="d-flex mt-3">
                                    <img class="me-2 rounded" src="/images/users/avatar-8.jpg"
                        ...
                        <div class="d-flex mb-2">
                            <img src="/images/users/avatar-1.jpg" height="32" class="align-self-start rounded me-2"
                                alt="Arya Stark" />
                            <div class="w-100">
            ...
            <div class="card">
                <div class="card-body pb-1">
                    <div class="d-flex">
                        <img class="me-2 rounded" src="/images/users/avatar-5.jpg" alt="Generic placeholder image"
                            height="32">
                        <div class="w-100">
                            <div class="dropdown float-end text-muted">
                                <a href="#" class="dropdown-toggle arrow-none card-drop" data-bs-toggle="dropdown"
                    ...
                    <div class="my-3">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <img src="/images/small/small-4.jpg" alt="post-img"
                                    class="rounded me-1 mb-3 mb-sm-0 img-fluid" />
                            </div>
                            <div class="col">
                                <img src="/images/small/small-2.jpg" alt="post-img"
                                    class="rounded me-1 img-fluid mb-3" />
                                <img src="/images/small/small-3.jpg" alt="post-img" class="rounded me-1 img-fluid" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center mb-3">
                <a href="javascript:void(0);" class="text-danger"><i class="mdi mdi-spin mdi-loading me-1 font-16"></i>
                    Load more </a>
            </div>
            <!-- end loader -->
        </div>
