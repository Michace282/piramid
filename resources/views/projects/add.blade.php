@extends('layouts.vertical', ['title' => 'Create Project', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
@include('layouts.shared/page-title',['page_title' => 'Create Projects','sub_title' => 'Projects'])
...
@section('script')
    @vite(['resources/js/ui/component.fileupload.js'])
@endsection
