@extends('layouts.vertical', ['title' => 'Project Details', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    @include('layouts.shared/page-title',['page_title' => 'Projects Details','sub_title' => 'Projects'])
...
@section('script')
    @vite(['resources/js/pages/demo.project-detail.js'])
@endsection
