@extends('layouts.vertical', ['title' => 'Projects List', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
@include('layouts.shared/page-title',['page_title' => 'Projects List','sub_title' => 'Projects'])

    <div class="row mb-2">
        <div class="col-sm-4">
            <a href="{{ route('second', ['projects', 'add']) }}" class="btn btn-danger rounded-pill mb-3"><i class="mdi mdi-plus"></i> Create Project</a>
        </div>
        <div class="col-sm-8">
    ...
    <div class="row">
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                <!-- project-thumbnail -->
                <img class="card-img-top" src="/images/projects/project-1.jpg" alt="project image cap">
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                <!-- project-thumbnail -->
                <img class="card-img-top" src="/images/projects/project-2.jpg" alt="project image cap">
                <div class="card-img-overlay">
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                <!-- project-thumbnail -->
                <img class="card-img-top" src="/images/projects/project-3.jpg" alt="project image cap">
                <div class="card-img-overlay">
                    <div class="badge text-bg-secondary p-1">Ongoing</div>
                </div>
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                <!-- project-thumbnail -->
                <img class="card-img-top" src="/images/projects/project-4.jpg" alt="project image cap">
                <div class="card-img-overlay">
                    <div class="badge text-bg-secondary p-1">Ongoing</div>
                </div>
