@extends('layouts.vertical', ['title' => 'CRM Projects', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    ...
    @include('layouts.shared/page-title',['page_title' => 'Projects','sub_title' => 'CRM'])
    <div class="row">
        <div class="col-xxl-9">
            <div class="row">
                <div class="col-sm-6 col-xl-3 mb-3">
                    <div class="card mb-0 h-100">
                        <div class="card-body">
                            ...
                            <h5 class="text-muted fw-normal mt-0 text-truncate" title="Campaign Sent">New Task
                                Assign</h5>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mt-4">
                                ...
                                <div class="text-end multi-user">
                                    ...
                                    <a href="javascript:void(0);" class="d-inline-block">
                                        <img src="/images/users/avatar-7.jpg" class="rounded-circle avatar-xs"
                                             alt="friend">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <a href="javascript:void(0);" class="text-center text-muted p-2" data-bs-toggle="modal"
                                   data-bs-target="#CreateProject">
                                    <i class="mdi mdi-plus h3 my-0"></i> <h4 class="font-16 mt-1 mb-0 d-block">Add New
                                        Project</h4>
                                </a>
                            </div>
                        </div> <!-- end card-body -->
            ...
            <div class="card">
                ...
                <div class="card-body pt-1">
                    <div class="d-flex align-items-center border border-light rounded p-2 mb-2">
                        ...
                        <a href="javasript:void(0)" class="text-muted" data-bs-toggle="tooltip" data-bs-placement="top"
            ...
            <div class="card card-h-100">
                ...
                <div class="card-body py-0 mb-3" data-simplebar style="max-height: 304px;">
                    ...
                    <div class="border rounded p-2 mb-2">
                        <ul class="list-inline mb-2">
                            <li class="list-inline-item font-16 fw-semibold"><a href="javascript:void(0);"
                                                                                class="text-reset">Admin Dashboard</a>
                            </li>
                            <li class="list-inline-item text-muted"><i class="mdi mdi-circle-small"></i></li>
                    ...
                    <div class="border rounded p-2 mb-2">
                        <ul class="list-inline mb-2">
                            <li class="list-inline-item font-16 fw-semibold"><a href="javascript:void(0);"
                                                                                class="text-reset">Client Work</a></li>
                            <li class="list-inline-item text-muted"><i class="mdi mdi-circle-small"></i></li>
                    ...
                    <div class="border rounded p-2 mb-2">
                        <ul class="list-inline mb-2">
                            <li class="list-inline-item font-16 fw-semibold"><a href="javascript:void(0);"
                                                                                class="text-reset">UI/UX Design</a></li>
                            <li class="list-inline-item text-muted"><i class="mdi mdi-circle-small"></i></li>
            ...
            <div class="card card-h-100">
                ...
                <div class="card-body py-0 mb-3" data-simplebar style="max-height: 304px;">
                    <div class="d-flex align-items-start">
                        <img class="me-3 rounded-circle" src="/images/users/avatar-2.jpg" width="40"
                             alt="Generic placeholder image">
                        <div class="w-100 overflow-hidden">
                            <h5 class="mt-0 mb-1 fw-semibold"><a href="javascript:void(0);" class="text-reset">Risa
                                    Pearson</a></h5>
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="/images/users/avatar-3.jpg" width="40"
                             alt="Generic placeholder image">
                        <div class="w-100 overflow-hidden">
                            <h5 class="mt-0 mb-1 fw-semibold"><a href="javascript:void(0);" class="text-reset">Margaret
                                    D. Evans</a></h5>
                            <ul class="list-inline mb-0 font-13">
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="/images/users/avatar-4.jpg" width="40"
                             alt="Generic placeholder image">
                        <div class="w-100 overflow-hidden">
                            <h5 class="mt-0 mb-1 fw-semibold"><a href="javascript:void(0);" class="text-reset">Bryan J.
                                    Luellen</a></h5>
                            <ul class="list-inline mb-0 font-13">
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="/images/users/avatar-5.jpg" width="40"
                             alt="Generic placeholder image">
                        <div class="w-100 overflow-hidden">
                            <h5 class="mt-0 mb-1 fw-semibold"><a href="javascript:void(0);" class="text-reset">Kathryn
                                    S. Collier</a></h5>
                            <ul class="list-inline mb-0 font-13">
                                <li class="list-inline-item">UI/UX Designer</li>
                                <li class="list-inline-item text-muted"><i class="mdi mdi-circle-small"></i></li>
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="/images/users/avatar-1.jpg" width="40"
                             alt="Generic placeholder image">
                        <div class="w-100 overflow-hidden">
                            <h5 class="mt-0 mb-1 fw-semibold"><a href="javascript:void(0);" class="text-reset">Timothy
                                    Kauper</a></h5>
                            <ul class="list-inline mb-0 font-13">
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="/images/users/avatar-6.jpg" width="40"
                             alt="Generic placeholder image">
                        <div class="w-100 overflow-hidden">
                            <h5 class="mt-0 mb-1 fw-semibold"><a href="javascript:void(0);" class="text-reset">Zara
                                    Raws</a></h5>
                            <ul class="list-inline mb-0 font-13">
...
@section('script')
    @vite(['resources/js/pages/demo.crm-project.js'])
@endsection
