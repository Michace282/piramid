@extends('layouts.vertical', ['title' => 'CRM Management', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('css')
    @vite(['node_modules/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css'])
@endsection

@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Management', 'sub_title' => 'CRM'])
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dropdown float-end">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item"><i class=""></i><i
                                            class="uil uil-pen me-1"></i> Edit</a>
                                    <!-- item-->
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <a href="javascript:void(0);" class="font-16 fw-bold text-reset">Ecommerce App Design <i
                            ...
                            <span class="font-12 fw-semibold text-muted"><i class="mdi mdi-clock-time-four me-1"></i>145
                                Hours</span>
                                ...
                                <div class="col-6 text-end">
                                    ...
                                    <div class="multi-user">
                                        <a href="javascript:void(0);" class="d-inline-block">
                                            <img src="/images/users/avatar-1.jpg" class="rounded-circle avatar-xs"
                                                alt="friend">
                                        </a>
                                        <a href="javascript:void(0);" class="d-inline-block">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <a href="javascript:void(0);" class="font-16 fw-bold text-reset">Client Power System
                                        <i class="mdi mdi-checkbox-marked-circle-outline text-success"></i></a>
                                    <p class="text-muted mb-0">Dashboard, Power System Pages</p>
                                </div>
                            </div>

                            <span class="badge badge-lg bg-light text-reset rounded-pill me-1">Work in Progress</span>
                            <span class="font-12 fw-semibold text-muted"><i class="mdi mdi-clock-time-four me-1"></i>260
                                Hours</span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <a href="javascript:void(0);" class="font-16 fw-bold text-reset">Landing Pages Design
                                        <i class="mdi mdi-checkbox-marked-circle-outline text-success"></i></a>
                            ...
                            <span class="badge badge-lg bg-light text-reset rounded-pill me-1">Work in Progress</span>
                            <span class="font-12 fw-semibold text-muted"><i class="mdi mdi-clock-time-four me-1"></i>48
                                Hours</span>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-6 text-end">
                                    ...
                                    <div class="multi-user">
                                        <a href="javascript:void(0);" class="d-inline-block">
                                            <img src="/images/users/avatar-5.jpg" class="rounded-circle avatar-xs"
                                                alt="friend">
                                        </a>
                                        <a href="javascript:void(0);" class="d-inline-block">
                                            <img src="/images/users/avatar-6.jpg" class="rounded-circle avatar-xs"
                                                alt="friend">
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <a href="javascript:void(0);" class="font-16 fw-bold text-reset">Business Dashboard
                                        Design <i class="mdi mdi-checkbox-marked-circle-outline text-success"></i></a>
                                    <p class="text-muted mb-0">Dashboard, Components Pages</p>
                                </div>
                            </div>

                            <span class="badge badge-lg bg-light text-reset rounded-pill me-1">Work in Progress</span>
                            <span class="font-12 fw-semibold text-muted"><i class="mdi mdi-clock-time-four me-1"></i>24
                                Hours</span>
            ...
            <div class="card">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item"><i
                                        class="mdi mdi-account me-1"></i>Visite Profilo</a>
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item"><i
                                        class="mdi mdi-block-helper me-1"></i>Block</a>
                                <!-- item-->
                                <div class="dropdown-divider my-1"></div>
                                <a href="javascript:void(0);" class="dropdown-item text-danger"><i
                                        class="mdi mdi-trash-can-outline me-1"></i>Remove</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="d-flex justify-content-between align-items-center card-body py-2 border-top border-light">
                    ...
                    <a href="javascript:void(0);" class="text-muted" data-bs-toggle="modal"
                        data-bs-target="#client-chat"><i class="uil uil-comment-alt-lines font-18"
                            data-bs-toggle="tooltip" data-bs-placement="top" title="Chat"></i></a>
                </div>
            </div>
        </div> <!-- end col -->
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img class="rounded-circle" src="/images/users/avatar-1.jpg"
                                                    alt="Avtar image" width="31">
                                            </div>
                                            <div class="flex-grow-1 ms-2">
                                                Adam Baldwin
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img class="rounded-circle" src="/images/users/avatar-2.jpg"
                                                    alt="Avtar image" width="31">
                                            </div>
                                            <div class="flex-grow-1 ms-2">
                                                Peter Wallace
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img class="rounded-circle" src="/images/users/avatar-3.jpg"
                                                    alt="Avtar image" width="31">
                                            </div>
                                            <div class="flex-grow-1 ms-2">
                                                Jacob Dunn
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img class="rounded-circle" src="/images/users/avatar-4.jpg"
                                                    alt="Avtar image" width="31">
                                            </div>
                                            <div class="flex-grow-1 ms-2">
                                                Terry Adams
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img class="rounded-circle" src="/images/users/avatar-5.jpg"
                                                    alt="Avtar image" width="31">
                                            </div>
                                            <div class="flex-grow-1 ms-2">
                                                Jason Stovall
            ...
            <div class="card">
                ...
                <div class="card-body pt-2">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="progress" style="height: 6px;">
                            <div class="progress-bar bg-danger" role="progressbar" style="width: 68%" aria-valuenow="68"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
...
@section('script')
    @vite(['resources/js/pages/demo.crm-management.js'])
@endsection
