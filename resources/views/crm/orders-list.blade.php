@extends('layouts.vertical', ['title' => 'CRM Orders List', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'Order List', 'sub_title' => 'CRM'])
                        ...
                        <table class="table table-centered table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#CM9708</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#CM9707</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#CM9706</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#CM9705</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#CM9704</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#CM9703</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#CM9702</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#CM9701</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#CM9700</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/images/users/avatar-9.jpg" class="rounded-circle avatar-xs"
                                                        alt="friend">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                ...
                                <tr>
                                    ...
                                    <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#CM9699</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
