@extends('layouts.vertical', ['title' => 'Project Dashboard', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    ...
    @include('layouts.shared/page-title',['page_title' => 'Projects','sub_title' => 'Dashboard'])
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap table-hover mb-0">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-start">
                                        <img class="me-2 rounded-circle" src="/images/users/avatar-2.jpg" width="40" alt="Generic placeholder image">
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-start">
                                        <img class="me-2 rounded-circle" src="/images/users/avatar-6.jpg" width="40" alt="Generic placeholder image">
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-start">
                                        <img class="me-2 rounded-circle" src="/images/users/avatar-3.jpg" width="40" alt="Generic placeholder image">
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-start">
                                        <img class="me-2 rounded-circle" src="/images/users/avatar-4.jpg" width="40" alt="Generic placeholder image">
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-start">
                                        <img class="me-2 rounded-circle" src="/images/users/avatar-5.jpg" width="40" alt="Generic placeholder image">
                                        <div>
...
@section('script-bottom')
    @vite(['resources/js/pages/demo.dashboard-projects.js'])
@endsection
