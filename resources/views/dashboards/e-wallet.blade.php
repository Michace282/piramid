@extends('layouts.vertical', ['title' => 'E-Wallet Dashboard', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])

@section('content')
    @include('layouts.shared/page-title', ['page_title' => 'E-Wallet', 'sub_title' => 'Dashboard'])
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="mb-0 text-muted"><i class="mdi mdi-arrow-up-bold text-success"></i> 45% This
                                        Week</p>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="mb-0 text-muted"><i class="mdi mdi-arrow-up-bold text-success"></i> 32% This
                                        Week</p>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h4 class="mt-0 mb-1 font-20">$12,500</h4>
                                    <p class="mb-0 text-muted"><i class="mdi mdi-arrow-up-bold text-success"></i> 60% This
                                        Week</p>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-6 col-xxl-12">
                    <div class="card bg-primary card-bg-img"
                        style="background-image: url(/images/bg-pattern.png);">
                        <div class="card-body">
...
@section('script-bottom')
    ...
    @vite(['resources/js/pages/demo.dashboard-wallet.js'])
@endsection
